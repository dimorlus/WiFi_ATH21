// mainwindow.cpp - HT_view visualizer
// 
// СВЯЗАННЫЕ ПРОЕКТЫ:
// - mqtt_logger/main.cpp - собирает данные для этого визуализатора
// - config.ini - общий формат парсинга CSV
//
// ИСТОРИЯ РАЗРАБОТКИ:
// - Решена проблема с клавишей P (переключение точки/линии) 
// - Добавлена навигация D/W/M с автоподстройкой масштаба
// - Исправлено обновление шкалы времени при зуме
// 
// КЛЮЧЕВЫЕ МЕТОДЫ:
// - toggleDisplayMode() - переключение сырые/сглаженные данные
// - updateTimeScale() - автоматическая настройка шкалы времени
// - updateStatusStats() - статистика для видимого диапазона
